...
public class RegisterUserManagedBean {
	...
	@PostConstruct
	void init() {
		email = (String) HttpSessionUtil.getSession().getAttribute("reciver");
...
//		}
//		facesContext.addMessage(null, new FacesMessage(
//				FacesMessage.SEVERITY_INFO, "User added", "Congrat. !"));
//		return Constants.USER;
//	}

	public void sendActivationStr(User user) {
		try {
			if (!user.equals(null)) {
				...
				String url = baseUrl + "/activation_view.xhtml?activation="
