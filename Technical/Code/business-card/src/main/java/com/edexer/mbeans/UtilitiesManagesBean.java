...
public class UtilitiesManagesBean {
	...
	private List<PrivacyLevel> privacyLevelList;
	...
	private void init() {
		...
		privacyLevelList=privacyServiceManager.listAllPrivacyLevel();
	...
	public PrivacyLevel getPrivacyLevel(int privacyId) {
		return privacyServiceManager.getPrivacyLevelById(privacyId);
	}
	...
	public List<PrivacyLevel> getPrivacyLevelList() {
		return privacyLevelList;
	}

	public void setPrivacyLevelList(List<PrivacyLevel> privacyLevelList) {
		this.privacyLevelList = privacyLevelList;
	}
